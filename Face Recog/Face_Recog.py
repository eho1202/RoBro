...
while(True):
    ...
    faces = face_cascade.detectMultiScale(
        rotate_img, scaleFactor=1.5, minNeighbors=5)  # Recog. faces
    for (x, y, w, h) in faces:
        ...
        if conf >= 70:
            ...
            cv2.putText(rotate_img, name, (x, y), font, 1, (0, 0, 255), 2)

        cv2.rectangle(rotate_img, (x, y), (x+w, y+h), (0, 255, 0), 2)

    cv2.imshow('Preview', rotate_img)  # Display the Video
